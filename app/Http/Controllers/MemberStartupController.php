...
class MemberStartupController extends Controller
{
    /**
    ...
    {
        return view("adminpage.content.manajemen_member.umkm.index");
        // return view('member.startup.index');
    }
    ...
    {
        return view("adminpage.content.manajemen_member.umkm.create");
        // return view('member.startup.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $memberType = MemberType::where('name', 'startup')->first()->id;
        ...
        return redirect("/umkm")
            ->with('success', 'Success create Startup!');
    }
    ...
    public function edit($id)
    {
        ...
        $data['member'] = Member::with(['user','category.meta_name'])->find($id);
        $data['category'] = MetaMemberCategory::orderBy('name')->get();

        foreach ($data['member']['user']['permissions'] as $permissions) {
            if ($permissions['name'] == "approved") {
                $data['approved'] = true;
            }
        }

        return view("adminpage.content.manajemen_member.umkm.edit", $data);
        // return view('member.startup.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('umkm.index')->with('success', 'Success update member!');
    }
    ...
    public function datatable(Request $request){
        $type = MemberType::where('name', 'UMKM')->first()->id;
        $data = Member::with(['member_core', 'category.meta_name', 'user.permissions'])->where('member_type_id' , $type);
