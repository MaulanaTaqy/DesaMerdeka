...
class MemberKomunitasController extends Controller
{
    public function index()
    {
        return view("adminpage.content.manajemen_member.industri.index");
    }
    ...
    {
        return view("adminpage.content.manajemen_member.industri.create");
        // return view('member.komunitas.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            // $memberType = MemberType::where('name', 'Komunitas')->first()->id;
            $memberType = MemberType::where('name', 'Komunitas')->first()->id;
        try {
            DB::beginTransaction();
        ...
        return redirect("/industri")
            ->with('success', 'Success create Komunitas!');
    }
    ...
    public function edit($id)
    {
        ...
        return view("adminpage.content.manajemen_member.industri.edit", $data);
        // return view('member.komunitas.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $path_img = 'files/komunitas/image/';
        ...
        return redirect()->route('industri.index')->with('success', 'Success update member!');
    }
    ...
    public function datatable(Request $request){
        $type = MemberType::where('name', 'Industri')->first()->id;
        $data = Member::with(['category.meta_name', 'user.permissions'])->where('member_type_id' , $type);
