...
<script>
    $(document).ready(function () {
        ...
        $('#btn-add-upload').on('click', function(e) {
            $('#initiator').append(`
                <div class="col-3">
                    <input class="dropify" type="file" name="banner_image[]" data-max-file-size="2M" data-allowed-file-extensions="jpeg jpg png webp svg"/>
                </div>
            `);
        ...
        $('#btn-submit').on('click', function(e) {
            ...
            if($('#summernote').summernote('isEmpty'))  alert('Blog / Article content cannot be null!');
            else $('#form').submit();
        })
