    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"> Management Product</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="row row-sm">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <select class="form-control form-select" id="category" style="
                width: 40%;
                position: absolute;
                left: 32%;
                z-index: 1;
                    ...
                    <table id="datatable" class="border-top-0 table table-bordered border-bottom">
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0">Product By</th>
        ...
        table = $("#datatable").DataTable({
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    let state = ``;
                        if(data == 'Approved'){
                            state = `<a class="badge bg-success me-1" href="javascript:void(0);">${data}</a>`;
                        }else{
                            state = `<a class="badge bg-warning me-1" href="javascript:void(0);">${data}</a>`;
                        }
