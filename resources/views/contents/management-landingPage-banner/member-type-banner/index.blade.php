    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"> Member Type</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">List Member Type</h3>
            </div>
            <div class="card-body">
            ...
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <label class="form-label text-dark">File</label>
                            <div>
                        ...
                        <div class="form-group">
                            <label class="form-label text-dark">Member Type</label>
                            <select id="member_type_id" name="member_type_id" class="form-control form-select" required>
...
<script>
    ...
    function create(){
        ...
        $('.modal-title').text('Add Data Member Type');
    }
    ...
    function edit(id){
        ...
        $.get(url, function (response) {
            ...
            $('#member_type_id').val(response.member_type.id).change();
