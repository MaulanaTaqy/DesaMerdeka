    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $("#datatable").DataTable({
                ...
                serverSide: true,
                autoWidth: false,
                ajax: "{{ route('contact-banner.datatable') }}",
                columnDefs: [
                {
                    targets: 0,
        ...
        function create(){
            ...
            $('.modal-title').text('Add Data Contact Banner');
        }
        ...
        function edit(id){
            ...
            var url = "{{ route('contact-banner.edit',":id") }}";
        ...
        var url = "{{ route('contact-banner.store') }}";
        
        $('#btnSave').text('Menyimpan...');
        $('#btnSave').attr('disabled', true);

        if(submit_method == 'edit'){
            url = "{{ route('contact-banner.update',':id') }}";
            url = url.replace(':id', id);
        ...
        function destroy(id) {
            var url = "{{ route('contact-banner.destroy',":id") }}";
            url = url.replace(':id', id);
