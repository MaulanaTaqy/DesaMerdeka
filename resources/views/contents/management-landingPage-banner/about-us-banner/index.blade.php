            ...
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input id="image" class="dropify" type="file" name="image" data-max-file-size="2M" data-allowed-file-extensions="jpeg jpg png webp svg" data-default-file="" required />
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $("#datatable").DataTable({
            ...
            serverSide: true,
            autoWidth: false,
            ajax: "{{ route('about-us-banner.datatable') }}",
            columnDefs: [
            {
                targets: 0,
    ...
    function create(){
        ...
        $('.modal-title').text('Add About Us Banner');
    }
    ...
    function edit(id){
        ...
        var url = "{{ route('about-us-banner.edit',":id") }}";
    ...
    var url = "{{ route('about-us-banner.store') }}";
    
    $('#btnSave').text('Menyimpan...');
    $('#btnSave').attr('disabled', true);

    if(submit_method == 'edit'){
        url = "{{ route('about-us-banner.update',':id') }}";
        url = url.replace(':id', id);
    ...
    function destroy(id) {
        var url = "{{ route('about-us-banner.destroy',":id") }}";
        url = url.replace(':id', id);
