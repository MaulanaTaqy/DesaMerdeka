...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $("#datatable").DataTable({
            ...
            serverSide: true,
            autoWidth: false,
            ajax: "{{ route('gallery-banner.datatable') }}",
            columnDefs: [
            {
                targets: 0,
    ...
    function create(){
        ...
        $('.modal-title').text('Add Data Gallery Banner');
    }
    ...
    function edit(id){
        ...
        var url = "{{ route('gallery-banner.edit',":id") }}";
    ...
    var url = "{{ route('gallery-banner.store') }}";
    
    $('#btnSave').text('Menyimpan...');
    $('#btnSave').attr('disabled', true);

    if(submit_method == 'edit'){
        url = "{{ route('gallery-banner.update',':id') }}";
        url = url.replace(':id', id);
    ...
    function destroy(id) {
        var url = "{{ route('gallery-banner.destroy',":id") }}";
        url = url.replace(':id', id);
