                ...
                <div class="card-body">
                    <div class="d-flex">
                        ...
                        <div class="project-content">
                            ...
                            <ul>
                                <li>
                                    <span class="counter number-font">{{ $allEvent }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="card  overflow-hidden project-card">
                <div class="card-body">
                    <div class="d-flex">
                        ...
                        <div class="project-content">
                            <h6>Event Registered</h6>
                            <ul>
                                <li>
                                    <span class="counter number-font">{{ $eventCount  }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="card overflow-hidden project-card">
                <div class="card-body">
                    <div class="d-flex">
                        ...
                        <div class="project-content">
                            <h6>Event Incoming</h6>
                            <ul>
                                <li>
                                    <span class="counter number-font">{{ $evenIncoming }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="d-flex">
                        ...
                        <div class="project-content">
                            ...
                            <ul>
                                <li>
                                    <span class="counter number-font">{{ $eventJoined }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="card overflow-hidden h-100">
                <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-10">Register To Event</h4>
                ...
                <div class="card-body pd-y-7">
                    <div class="area chart-legend mb-0">
                        ...
                        <div>
                            {{-- <i class="mdi mdi-album text-pink me-2"></i>Amount Used a month --}}
                        </div>
                    </div>
                    <span  class="ht-300">{!! $guestEvent->container() !!}</span>
                </div>
            </div>
        </div>
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-4">
            <div class="card overflow-hidden h-100">
                <div class="card-body pb-3">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-10">Incoming Event</h4>
                        <i class="mdi mdi-dots-horizontal text-gray"></i>
                    </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="project-names">
                                            ...
                                            <p class="d-inline-block font-weight-semibold mb-0">{{ $item->title }}</p>
                                        </div>
                                    </td>
...
@section('script')
    ...
    <script src="{{ $guestEvent->cdn() }}"></script>
    ...
    <script>
     // ambil data jumlah event dari controller
     var data = {
    ...
    var ctx = document.getElementById("echart3").getContext("2d");
