    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Team Member
                </h3>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <a href="{{ route('team-member.create') }}" class="btn btn-primary mb-4 data-table-btn"><i class="fa fa-plus"></i> Team Member</a>
...
<script>
        ...
        table = $("#datatable").DataTable({
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    let btn = `
                    <div class="btn-list">
                        <a href="{{ route('team-member.edit', ':id') }}" class="btn btn-sm btn-primary"><span class="fe fe-edit"> </span></a>
    ...
    function destroy(id) {
        var url = "{{ route('team-member.destroy',":id") }}";
