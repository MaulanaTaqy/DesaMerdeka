...
@section('title', 'Management Speakers')
    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"> Management Speakers</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Member Speakers
                </h3>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <a href="{{ route('meta.speakers.create') }}" class="btn btn-primary mb-4 data-table-btn"><i class="fa fa-plus"></i> Speakers</a>
                    <table id="datatable" class="border-top-0  table table-bordered text-nowrap border-bottom">
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0">Link Facebook</th>
                                <th class="border-bottom-0">Link Instagram</th>
                                <th class="border-bottom-0">Link LinkedIn</th>
                                {{-- <th class="border-bottom-0">Link Youtube</th> --}}
        ...
        table = $("#datatable").DataTable({
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    let btn = `
                    <div class="btn-list">
                        <a href="{{ route('meta.speakers.edit', ':id') }}" class="btn btn-sm btn-primary"><span class="fe fe-edit"> </span></a>
