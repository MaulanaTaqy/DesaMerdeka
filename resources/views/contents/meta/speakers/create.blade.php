...
<div class="row">
    <div class="col-lg-12 col-md-12 col-md-12">
        <div class="card blog-edit">
            <form id="form" action="{{ route('meta.speakers.store') }}" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" value="{{ old('title') }}" placeholder="Keynote : eg Pembicara utama / Ketua DPR RI / etc" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="li_url" class="form-control" required>
                    </div>
                    {{-- <div class="form-group">
