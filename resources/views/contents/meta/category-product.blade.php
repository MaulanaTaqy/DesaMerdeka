                ...
                <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" placeholder="Nama.." value="{{ old('name') }}" name="name" class="form-control" id="name">
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
    var KTDatatablesServerSide = function () {
        ...
        var initDatatable = function () {
            dt = $("#datatable").DataTable({
                ...
                serverSide: true,
                // scrollX: true,
                ajax: "{{ route('meta.product-category.datatable') }}",
                columnDefs: [
                {
                    targets: 0,
    ...
    function edit(id){
        ...
        $('#form')[0].reset();
        var url = "{{ route('meta.product-category.edit',":id") }}";
    ...
    function submit() {
        ...
        var url = "{{ route('meta.product-category.store') }}";
    
        $('#btnSave').text('Menyimpan...');
        $('#btnSave').attr('disabled', true);

        if(submit_method == 'edit'){
            url = "{{ route('meta.product-category.update',":id") }}";
            url = url.replace(':id', id);
        }
    ...
    function destroy(id) {
        var url = "{{ route('meta.product-category.destroy',":id") }}";
        url = url.replace(':id', id);
