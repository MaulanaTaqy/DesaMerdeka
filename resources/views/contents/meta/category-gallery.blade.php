        ...
        <div class="card card-xl-stretch mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold fs-3 mb-1">List Gallery Category </span>
                </h3>
...
<script>
    ...
    var KTDatatablesServerSide = function () {
        ...
        var initDatatable = function () {
            dt = $("#datatable").DataTable({
                ...
                serverSide: true,
                // scrollX: true,
                ajax: "{{ route('meta.gallery-category.datatable') }}",
                columnDefs: [
                {
                    targets: 0,
    ...
    function create(){
        ...
        $('.modal-title').text('Add Data Gallery Category');
    }
    ...
    function edit(id){
        ...
        $('#form')[0].reset();
        var url = "{{ route('meta.gallery-category.edit',":id") }}";
        ...
        $.get(url, function (response) {
            ...
            $('#id').val(response.id);
            $('#modal_form').modal('show');
            $('.modal-title').text('Edit Data Gallery Category');
    ...
    function submit() {
        ...
        var url = "{{ route('meta.gallery-category.store') }}";
    
        $('#btnSave').text('Menyimpan...');
        $('#btnSave').attr('disabled', true);

        if(submit_method == 'edit'){
            url = "{{ route('meta.gallery-category.update',":id") }}";
            url = url.replace(':id', id);
        }
    ...
    function destroy(id) {
        var url = "{{ route('meta.gallery-category.destroy',":id") }}";
        url = url.replace(':id', id);
