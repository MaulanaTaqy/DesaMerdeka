    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"> Management Desa</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Member Desa
                </h3>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <a href="{{ route('desa.create') }}" class="btn btn-primary mb-4 data-table-btn"><i class="fa fa-plus"></i> Desa</a>
...
<script>
        ...
        table = $("#datatable").DataTable({
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    // <div class="btn-list">
                    //     ${state}
                    //     <a href="javascript:void(0)" onclick="edit('${data}')" class="btn btn-secondary modal-effect btn-edit" data-bs-effect="effect-super-scaled"><span class="fe fe-eye"> </span></a>
                    //     <a href="{{ route('desa.edit', ':id') }}" class="btn btn-primary"><span class="fe fe-edit"> </span></a>
                    //     <a href="javascript:void(0)" onclick="destroy('${data}')" class="btn btn-danger btn-delete"><span class="fe fe-trash-2"> </span></a>
                    // </div>
                    // `;
                    let state = ``;
                    ...
                    <div class="btn-list">
                        ${state}
                        <a href="{{ route('desa.edit', ':id') }}" class="btn btn-primary" title="Profile Member">Profile</a>
    ...
    function edit(id){
        var url = "{{ route('komunitas-asosiasi.show',":id") }}";
