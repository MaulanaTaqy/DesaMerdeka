        ...
        <div class="card blog-edit">
            ...
            <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <h5 class="bg-gray">INFORMASI STATUS REGISTRASI Desa</h5>
                    ...
                    <h5 class="bg-gray mt-4">INFORMASI Desa</h5>
                    <div class="form-group mb-4">
                        <label class="form-label text-dark">Nama Desa</label>
                    ...
                    <div class="form-group mb-4">
                        <label class="form-label text-dark">Email Desa</label>
                    ...
                    <h5 class="bg-gray mt-4">INFORMASI PIMPINAN Desa COMPANY</h5>
                    <div class="mb-3">
                    ...
                    <h5 class="bg-gray mt-4">INFORMASI KELENGKAPAN DOKUMEN Desa</h5>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="form-label text-dark">Name Desa Di NIB / Akte Perusahaan</label>
