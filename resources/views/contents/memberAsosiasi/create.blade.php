...
@section('title', 'Create Member Komunitas/Asosiasi')
    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Create Komunitas/Asosiasi</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12 col-md-12 col-md-12">
        <div class="card blog-edit">
            <form id="form" action="{{ route('komunitas-asosiasi.store') }}" method="POST" enctype="multipart/form-data">
            <div class="card-header">
                    <h3>FORM REGISTRASI</h3>
                </div>
                <div class="card-body">
                    @csrf
                    <h4 class="card-title mb-4">Registrasi Komunitas/Asosiasi Desa Merdeka oleh Super Admin</h4>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-3">
                                <label class="form-label text-dark">Nama Komunitas/Asosiasi</label>
                            </div>
                            <div class="col-md-9">
