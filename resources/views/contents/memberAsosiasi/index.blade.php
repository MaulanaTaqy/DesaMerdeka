...
@section('title', 'Member / Komunitas/Asosiasi')
    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"> Management Komunitas/Asosiasi</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Member Komunitas/Asosiasi
                </h3>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <a href="{{ route('komunitas-asosiasi.create') }}" class="btn btn-primary mb-4 data-table-btn"><i class="fa fa-plus"></i> Assosiasi</a>
...
<script>
        ...
        table = $("#datatable").DataTable({
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    <div class="btn-list">
                        ${state}
                        <a href="{{ route('komunitas-asosiasi.edit', ':id') }}" class="btn btn-primary" title="Profile Member">Profile</a>
    ...
    function edit(id){
        ...
        $.get(url, function (response) {
            ...
            $('#fb_url').attr('href', validateUrl(response.response.fb_url));
            $('#ig_url').attr('href', validateUrl(response.response.ig_url));
