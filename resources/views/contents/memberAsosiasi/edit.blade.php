...
@section('title', 'Edit Member Komunitas/Asosiasi')
    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Komunitas/Asosiasi</li>
            </ol>
        </nav>
    </div>
</div>
            ...
            <form id="form" action="{{ route('komunitas-asosiasi.update', $member->id) }}" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="form-label text-dark">Name {{ $member->member_type->name }} Di Akta</label>
