...
@section('title', 'Create Akun Komunitas / Asosisasi')
...
<div class="row g-5 g-xl-8">
    <div class="col-xl-12">
        <div class="card card-xl-stretch mb-xl-8">
            ...
            <form action="{{ url('/komunitas-asosiasi') }}" method="POST">
                {{ csrf_field() }}
                <div class="card-body p-9">
                    <div class="row mb-7 form-group">
                        <label class="col-lg-2 fw-semibold text-muted" for="name"> Nama Komunitas / Asosiasi </label>
                        <div class="col-lg-8">
