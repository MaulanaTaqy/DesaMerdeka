...
@section('title', 'Profile Akun UMKM')
...
@section('toolbar')
    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
            ...
            <li class="breadcrumb-item">
                <a href="{{ url('/umkm') }}" class="text-muted text-hover-primary">UMKM</a>
            </li>
            <li class="breadcrumb-item">
                <span class="bullet bg-gray-400 w-5px h-2px"></span>
            </li>
        ...
        <div class="col-xl-12">
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-body border-top p-9">
                        ...
                        <table class="table table-bordered align-middle gs-0 gy-4">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    @if (empty($approved))
                                        <td class="text-center">
                                            <a onclick="approve('{{$member['user']['id']}}')" class="btn btn-success btn-sm">
                    ...
                    <form id="form" action="{{ route('umkm.update', $member->id) }}" method="POST"
                        ...
                        <div class="form-group mb-3">
                            <label for="name" class="form-label mb-2"> Nama UMKM </label>
                            <input type="text" class="form-control" name="name" id="name"
                                placeholder="Masukkan Nama UMKM" required value="{{ old('name') ?? $member->name }}">
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            <label for="email" class="form-label mb-2"> Email UMKM </label>
                            <input type="text" name="email" class="form-control" id="email"
                                placeholder="Masukkan Email" value="{{ old('email') ?? $member->email }}" required>
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="row form-group mb-3" style="margin-top: 20px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <input type="text" class="form-control" name="start_day" id="start_day"
                                            placeholder="Start Day" value="{{ old('start_day') ?? $member->start_day }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <input type="text" class="form-control" name="end_day" id="end_day"
                                            value="{{ old('end_day') ?? $member->end_day }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <input type="time" name="start_time" class="form-control"
                                            value="{{ old('start_time') ?? $member->start_time }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <input type="time" name="end_time" class="form-control"
                                            value="{{ old('end_time') ?? $member->end_time }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-6 mt-5">
                            ...
                            <label class="fw-semibold fs-6">
                                ...
                                <span class="ms-1" data-bs-toggle="tooltip"
                                    title="You can check more then one category">
                                            ...
                                            <div class="form-check form-check-custom form-check-solid form-check-sm">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="checkbox" name="category_ids[]"
                                                        value="{{ $item->id }}"> <span>{{ $item->name }}</span>
                                                </label>
                                            </div>
                                        </div>
                                    @endforeach
                        ...
                        <h4>INFORMASI PIMPINAN UMKM COMPANY</h4>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="director_name" id="director_name"
                                placeholder="Director Name" value="{{ old('director_name') ?? $member->director_name }}">
                        </div>
                        <div class="form-group mb-3">
                            <label for="email_director" class="form-label"> Email Pimpinan / Direktur / CEO </label>
                            <input type="text" class="form-control" name="email_director" id="email_director"
                                placeholder="Email Director"
                                value="{{ old('email_director') ?? $member->email_director }}">
                        </div>
                        <div class="form-group mb-3">
                            <label for="phone_director" class="form-label"> No. Telp Pimpinan / Direktur / CEO </label>
                            <input type="text" class="form-control" name="phone_director" id="phone_director"
                                placeholder="Phone Director"
                                value="{{ old('phone_director') ?? $member->phone_director }}">
                        </div>
                        <div class="form-group mb-3">
                            <label for="domicile_director" class="form-label"> Kota Domisili Bertempat Tinggal </label>
                            <input type="text" class="form-control" name="domicile_director" id="domicile_director"
                                placeholder="Domicile Director"
                                value="{{ old('domicile_director') ?? $member->domicile_director }}">
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="administrator_name" id="administrator_name"
                                ...
                                value="{{ old('administrator_name') ?? $member->administrator_name }}">
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <input type="email" class="form-control" name="email_admin" id="email_admin"
                                placeholder="Email Admin" value="{{ old('email_admin') ?? $member->email_admin }}">
                        </div>
                        <div class="form-group mb-3">
                            <label for="phone_admin" class="form-label"> No. Telp Admin </label>
                            <input type="text" class="form-control" name="phone_admin" id="phone_admin"
                                placeholder="No. Telp Admin" value="{{ old('phone_admin') ?? $member->phone_admin }}">
                        </div>
                        <div class="form-group mb-3">
                            <label for="domicile_admin" class="form-label"> Kota Domisili Bertempat Tinggal </label>
                            <input type="text" class="form-control" name="domicile_admin" id="domicile_admin"
                                placeholder="Domicile Admin"
                                value="{{ old('domicile_admin') ?? $member->domicile_admin }}">
                        </div>

                        <h4>INFORMASI KELENGKAPAN DOKUMEN UMKM</h4>

                        <div class="form-group mb-3">
                            <label for="deed_number" class="form-label"> Nomor Akte Pendirian / Akte Perusahaan <small
                                    class="text-danger">(Optional)</small> </label>
                            <input type="text" class="form-control" name="deed_number" id="deed_number"
                                placeholder="Deed Number" value="{{ old('deed_number') ?? $member->deed_number }}"
                                required>
                        </div>
                        <div class="form-group mb-3">
                            <label for="notary_name" class="form-label"> Nama UMKM Di NIB / Akte Perusahaan </label>
                            <input type="text" class="form-control" name="notary_name" id="notary_name"
                                placeholder="Notary Name" value="{{ old('notary_name') ?? $member->notary_name }}">
                        </div>
                        <div class="form-group mb-3">
                            <label for="since" class="form-label"> Tahun Berdiri </label>
                            <input type="number" class="form-control" name="since" id="since"
                                placeholder="Since" value="{{ old('since') ?? $member->since }}">
                        </div>
                        <div class="form-group mb-3">
                            <label for="website_url" class="form-label"> Website URL </label>
                            <input type="text" class="form-control" name="website_url" id="website_url"
                                placeholder="Website URL" value="{{ old('website_url') ?? $member->website_url }}">
                        </div>
                        <div class="form-group mb-3">
                            <label for="image" class="form-label"> Logo Image </label>
                            <input type="file" class="dropify" name="image" id="image" data-max-file-size="2M"
                                data-default-file="{{ asset($member->image) }}"
                                data-allowed-file-extensions="jpeg jpg png webp svg" />
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="file" class="dropify" name="company_profile_file" id="company_profile_file"
                                max-file-size="10000" data-max-file-size="10M" data-allowed-file-extensions="pdf"
                                accept=".pdf" data-default-file="{{ asset($member->company_profile_file) }}"
                                value="{{ old('company_profile_file') }}" />
                            <small class="text-secondary">max file size 10MB{!! $member->company_profile_file != ''
                                ? ' This member has upload the file. <a href="' . asset($member->company_profile_file) . '">download</a>'
                                : '' !!}</small>
                        </div>
                        <div class="form-group mb-3">
                            <label for="org_structure_file" class="form-label"> File Struktur Organisasi (PDF) </label>
                            <input type="file" class="dropify" name="org_structure_file" id="org_structure_file"
                                max-file-size="10000" data-max-file-size="10M" data-allowed-file-extensions="pdf"
                                accept=".pdf" data-default-file="{{ asset($member->org_structure_file) }}"
                                value="{{ old('org_structure_file') }}" />
                            <small class="text-secondary">max file size 10MB{!! $member->org_structure_file != ''
                                ? ' This member has upload the file. <a href="' . asset($member->org_structure_file) . '">download</a>'
                                : '' !!}</small>
                        </div>
                        <div class="form-group mb-3">
                            <label for="deed_file" class="form-label"> File Akta Pendirian (PDF) </label>
                            <input type="file" class="dropify" name="deed_file" id="deed_file" max-file-size="10000"
                                data-max-file-size="10M" data-allowed-file-extensions="pdf" accept=".pdf"
                                data-default-file="{{ asset($member->deed_file) }}" value="{{ old('deed_file') }}" />
                            <small class="text-secondary">max file size 10MB{!! $member->deed_file != ''
                                ? ' This member has upload the file. <a href="' . asset($member->deed_file) . '">download</a>'
                                : '' !!}</small>
                        </div>
                        <h4>INFORMASI GOOGLE MAP, SOSIAL MEDIA DAN FOTO 360</h4>
                        <div class="form-group mb-3">
                            <label for="gmap_url" class="form-label"> Google Maps Url </label>
                            <input type="text" class="form-control" name="gmap_url" id="gmap_url"
                                value="{{ old('gmap_url') ?? $member->gmap_url }}">
                        </div>
                        <div class="form-group mb-3">
                            <label for="fb_url" class="form-label"> Facebook Url </label>
                            <input type="text" class="form-control" name="fb_url" id="fb_url"
                                value="{{ old('fb_url') ?? $member->fb_url }}">
                        </div>
                        <div class="form-group mb-3">
                            <label for="ig_url" class="form-label"> Instagram Url </label>
                            <input type="text" class="form-control" name="ig_url" id="ig_url"
                                value="{{ old('ig_url') ?? $member->ig_url }}">
                        </div>
                        <div class="form-group mb-3">
                            <label for="google_plus_url" class="form-label"> Google Plus Url </label>
                            <input type="text" class="form-control" name="google_plus_url" id="google_plus_url"
                                value="{{ old('google_plus_url') ?? $member->google_plus_url }}">
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="view_1_url" class="form-control"
                                value="{{ old('view_1_url') ?? $member->view_1_url }}">
                        </div>
                        <div class="form-group mb-3">
                            <label class="form-label" for="view_2_url"> Google Street View 360 - (2) URL </label>
                            <input type="text" name="view_2_url" class="form-control"
                                value="{{ old('view_2_url') ?? $member->view_2_url }}">
                        </div>
                        <div class="form-group mb-3">
                            <label class="form-label" for="view_3_url"> Google Street View 360 - (3) URL </label>
                            <input type="text" name="view_3_url" class="form-control"
                                value="{{ old('view_3_url') ?? $member->view_3_url }}">
                        </div>
                        <div class="form-group mb-3">
