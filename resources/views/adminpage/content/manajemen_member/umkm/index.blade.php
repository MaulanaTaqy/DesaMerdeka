            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    if(full.user.permissions.findIndex(item => item.name === 'approved') < 0){
                        state = `<a href="javascript:void(0)" onclick="approve('${full.user.id}')" class="btn btn-sm btn-icon btn-success btn-approval" title="Approve"><span class="fa fa-check"> </span></a>`;
                    }

                    let btn = `
                    <div class="btn-list">
                        ${state}
                        <a href="{{ route('umkm.edit', ':id') }}" class="btn btn-primary btn-sm" title="Profile Member">Profile</a>
                        <a href="javascript:void(0)" onclick="destroy('${data}')" class="btn btn-danger btn-delete btn-sm" title="Delete Member"><span class="fa fa-trash"> </span></a>
                    </div>
                    `;
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    if(role == 'admin' || is_can){
                        state = `<a href="javascript:void(0)" onclick="check('${data}')" class="btn btn-icon btn-success btn-sm btn-is-show" title="Show this item on Homepage"><span class="fa fa-check"> </span></a>`;
                    
                        if(!!+full.is_showed)
                            state = `<a href="javascript:void(0)" onclick="uncheck('${data}')" class="btn btn-icon btn-warning btn-sm btn-is-show" title="Hide this item on Homepage"><span class="fa fa-times"> </span></a>`;
                    }
