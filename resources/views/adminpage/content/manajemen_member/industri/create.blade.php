...
@section('title', 'Create Akun Industri')
...
<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{ url('/industri') }}" class="text-muted text-hover-primary">Industri</a>
        </li>
        <li class="breadcrumb-item">
            <span class="bullet bg-gray-400 w-5px h-2px"></span>
        </li>
...
<div class="row g-5 g-xl-8">
    <div class="col-xl-12">
        <div class="card card-xl-stretch mb-xl-8">
            ...
            <form action="{{ url('/industri') }}" method="POST">
                {{ csrf_field() }}
                <div class="card-body p-9">
                    <div class="row mb-7 form-group">
                        <label class="col-lg-2 fw-semibold text-muted" for="name"> Nama Industri </label>
                        <div class="col-lg-8">
