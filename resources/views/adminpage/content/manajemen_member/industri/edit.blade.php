...
@section('title', 'Profile Akun Industri')
...
<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('industri.index') }}" class="text-muted text-hover-primary">Industri</a>
        </li>
        <li class="breadcrumb-item">
            <span class="bullet bg-gray-400 w-5px h-2px"></span>
        </li>
        ...
        <div class="card card-xl-stretch mb-xl-8">
            <form id="form" action="{{ route('industri.update', $member->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body py-3">
                    ...
                    <div class="form-group mb-3">
                        <label for="name" class="form-label"> Name Industri Di Akta </label>
                        <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="{{ old('comunity_name') ?? $member->comunity_name }}">
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div id="short_about_desc" class="min-h-200px mb-2">{!! $member->desc !!}</div>
                    </div>
