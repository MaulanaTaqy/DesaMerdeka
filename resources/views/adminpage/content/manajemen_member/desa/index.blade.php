        ...
        <div class="card card-xl-stretch mb-xl-8">
            <div class="card-header border-0 pt-5">
                ...
                <div class="card-toolbar">
                    <a href="{{ url('/desa/create') }}" class="btn btn-primary">
        ...
        table = $("#example").DataTable({
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    <div class="btn-list">
                        ${state}
                        <a href="{{ route('desa.edit', ':id') }}" class="btn btn-primary btn-sm" title="Profile Member">Profile</a>
            ...
            }, 
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    if(role == 'admin' || is_can){
                        ...
                        if(!!+full.is_showed)
                        state = `<a href="javascript:void(0)" onclick="uncheck('${data}')" class="text-center btn btn-icon btn-warning btn-is-show btn-sm" title="Hide this item on Homepage"><span class="fa fa-times"> </span></a>`;
                    }
            ...
            { 
                ...
                render: function(data) {
                    return `<img style='width: 100px;' src="{{ asset('${data}') }}" />`;
                }
            }, 
            { data: 'user.email'}, 
            { 
