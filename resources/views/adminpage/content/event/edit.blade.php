                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-5 ">
                        <div id="video-initiator">
                            <input type="text" value="{{ $event->video }}" name="video_url[]" class="form-control mb-2" id="">
                        </div>
                    </div>
                    ...
                    <div class="form-label">
                        ...
                        <select id="keynote-speaker" name="keynote_speaker_id" class="form-control select2 form-select" multiple="multiple" >
                    ...
                    <div class="form-label">
                        ...
                        <input type="time" id="start_time" name="start_time" class="form-control form-control-lg form-control-solid" value="{{ date('d-m-Y H:i', strtotime($event->start_datetime)) }}" >
                    </div>
                    <div class="form-label">
                        <label class="form-label text-dark">Tanggal Berakhir Event</label>
                        <input type="time" id="end_time" name="end_time" class="form-control form-control-lg form-control-solid" value="{{ date('d-m-Y H:i', strtotime($event->end_datetime)) }}" >
                    </div>
                    <div class="form-label">
                    ...
                    <div class="input-group mb-5">
                        <input type="text" name="fb_url" class="form-control" value="{{ old('fb_url') ?? $event->fb_url }}" placeholder="Contoh : https://facebook.com/sampleuser.7">
                    </div>
                    <label class="form-label text-dark">Instagram URL</label>
                    <div class="input-group mb-5">
                        <input type="text" name="ig_url" class="form-control" value="{{ old('ig_url') ?? $event->ig_url }}" placeholder="Contoh : https://instagram.com/sampleuser.7">
                    </div>
                    <label class="form-label text-dark">Tiktok URL</label>
                    <div class="input-group mb-5">
                        <input type="text" name="tk_url" class="form-control" value="{{ old('tk_url') ?? $event->tk_url }}" placeholder="Contoh : https://tiktok.com/sampleuser.7">
                    </div>
                    <label class="form-label text-dark">Youtube Channel URL</label>
                    <div class="input-group mb-5">
                        <input type="text" name="yt_url" class="form-control" value="{{ old('yt_url') ?? $event->yt_url }}" placeholder="Contoh : https://www.youtube.com/@KakaoGames">
                    </div>
                </div>
                <div class="card-footer">
                    <button id="btn-submit" class="btn btn-primary float-end my-2">Update</button>
                </div>
            </form>
        </div>
    </div>
