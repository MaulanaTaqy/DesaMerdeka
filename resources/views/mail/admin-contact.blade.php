...
<body>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" style="padding: 0px; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; border-collapse: collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;">
                                                                                        <a class="aw-image-link" href="http://www.aweber.com" style="border-width: 0px; border-style: none; text-decoration: none;" target="_blank" rel="noopener noreferrer">
                                                                                            <img class="model" src="{{ asset('public/assets/images/brand.png') }}" style="display: block; width: 600px; height: 283px; border-width: 0px; border-style: none; line-height: 100%; max-width: 100%; outline-width: medium; outline-style: none; text-decoration: none; color: rgb(51, 51, 51); font-size: 20px; font-weight: 700; border-radius: 10px;" alt="Image" width="600" height="283">
                                                                                        </a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                ...
                                                                <div class="definition-parent">
                                                                    <div class="text-element paragraph">
                                                                        <div style="color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">
                                                                            ...
                                                                            <p style="color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">
                                                                                I'am {{ $request->name }}, <br>
                                                                                {{ $request->message }}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="definition-parent">
                                                                    <div class="text-element paragraph">
                                                                        <div style="color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">
                                                                            ...
                                                                            <p style="color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">
                                                                                Please contact me back to :
                                                                                <ul style="color: rgb(51, 51, 51);">
                                                                                    <li style="color: rgb(51, 51, 51);">Email : {{ $request->email }}</li>
                                                                                    <li style="color: rgb(51,51, 51);">Phone : {{ $request->phone }}</li>
                                                                                    <li style="color: rgb(51, 51, 51);">Or visit my website : {{ $request->website }}</li>
                                                                                </ul>
                                                                            </p>
                                                                        </div>
                                                                    </div>
    ...
    <div align="center" id="aweber_container" style="background-color:#ffffff; width:100% !important">
        <div id="aweber_rem" style="box-sizing:border-box; color:#000000 !important; font-family:Helvetica,Arial,sans-serif !important; font-size:12px !important; line-height:16px; margin:0px; max-width:600px; padding:0px 8px; width:100%">
            ...
            <div class="rem_align" style="text-align:center;"><span style="color:#000000 !important"></span><br><br>
                <a href="{{ url('/') }}" rel="noopener noreferrer" style="color: #000000;" target="_blank">
                <span style="color:#000000 !important">VirtualDesa</span></a> &nbsp; 
                <br><br>
            </div>
            <!--[if gte mso 9]></td></tr></table><![endif]-->
        </div>
