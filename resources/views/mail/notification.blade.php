                                                ...
                                                <td align="center" bgcolor="#ffffff">
                                                            ...
                                                            <tr>
                                                                <td width="100%" align="center">
                                                                    <p style="font-family:'Ubuntu', sans-serif; font-size:14px; color:#202020; padding-left:20px; padding-right:20px; text-align:justify;">
                                                                        Halo <span style="font-family:'Ubuntu Mono', monospace; color:#354fe4;">{{ $member->name }}!</span> 
                                                                    </p>
                                                                    <p style="font-family:'Ubuntu', sans-serif; font-size:14px; color:#202020; padding-left:20px; padding-right:20px; text-align:justify;">
                                                                        Kami ingin mengucapkan terima kasih yang sebesar-besarnya atas keputusan Anda untuk bergabung dengan <b style="color:#354fe4">Desa Merdeka</b>. Kami sangat menghargai kepercayaan dan keputusan Anda untuk menjadi bagian dari keluarga kami.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    ...
                                                    {{-- <table width="200" border="0" cellpadding="0" cellspacing="0" align="center">
                                                        <tbody>
                                                            <tr>
                                                                <td align="center" bgcolor="#1976D2">
                                                                    <a style="font-family:'Ubuntu Mono', monospace; display:block; color:#ffffff; font-size:14px; font-weight:bold; text-decoration:none; padding-left:20px; padding-right:20px; padding-top:20px; padding-bottom:20px;" href="">Verify E-mail Address</a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table> --}}
