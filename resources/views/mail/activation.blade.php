                                                            ...
                                                            <tr>
                                                                <td width="100%" align="center">
                                                                    <p style="font-family:'Ubuntu', sans-serif; font-size:14px; color:#202020; padding-left:20px; padding-right:20px; text-align:justify;">
                                                                        Terimakasih <span style="font-family:'Ubuntu Mono', monospace; color:#354fe4;">{{ $member->name }}</span> telah mendaftar di web Desa Merdeka, langkah selanjutnya yang harus anda lakukan adalah memverifikasi akun anda demi keamanan sistem kami dengan password <span style="font-family:'Ubuntu Mono', monospace; color:#354fe4;">{{ $request->password }}</span>. Klik tombol di bawah ini untuk melakukan aktivasi akun anda.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
