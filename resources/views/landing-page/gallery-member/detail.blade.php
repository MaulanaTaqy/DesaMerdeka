                                ...
                                <div class="card-body">
                                    ...
                                    <div class="services-part">
                                        <div class="services-icon">
                                            <img src="{{asset('assets/images/img-event/detail/kalender.png')}}" style="width: 20px;" class="services-txt"> {{ $item->gallery->date }}
                                        </div>
                                    </div>
                                    <div class="addon-services">
                                        <div class="services-icon">
                                            <img src="{{asset('assets/images/services/style1/icons/pin.png')}}" style="width: 20px;" class="services-txt"> {{ $item->gallery->location }}
                                        </div>
                                    </div>
                                </div>
                            </div>
