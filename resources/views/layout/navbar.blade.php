    ...
    <div class="container-fluid main-container ">
        <div class="main-header-left ">
            ...
            <div class="responsive-logo">
                <a href="{{ route('dashboard') }}" class="header-logo"><img src="{{ asset('virtual/assets/img/brand/logo.png') }}" class="logo-11"></a>
                <a href="{{ route('dashboard') }}" class="header-logo"><img src="{{ asset('virtual/assets/img/brand/logo.png') }}" class="logo-1"></a>
            </div>
                ...
                <div class="main-header-right">
                    ...
                    <div class="nav nav-item  navbar-nav-right mg-lg-s-auto">
                        ...
                        <div class="dropdown main-profile-menu nav nav-item nav-link">
                            ...
                            <a class="profile-user d-flex" href=""><img src="{{ asset(Auth::user()->{getRoleName()}->image ?? 'virtual/assets/img/default-user.webp') }}" alt="user-img" class="rounded-circle mCS_img_loaded"><span></span></a>

                            <div class="dropdown-menu">
                                <div class="main-header-profile header-img">
                                    <div class="main-img-user"><img src="{{ asset(Auth::user()->{getRoleName()}->image ?? 'virtual/assets/img/default-user.webp') }}"></div>
                                    <h6 class="px-4">{{ Auth::user()->{Auth::user()->getRoleNames()->first()}->name }}</h6><span>{{ Auth::user()->{Auth::user()->getRoleNames()->first()}->username }}</span>
                                </div>
