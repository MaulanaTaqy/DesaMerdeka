    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"> Management Industri</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Member Industri
                </h3>
            </div>
            <div class="card-body">
                <a href="{{ route('industri.create') }}" class="btn btn-primary mb-4 data-table-btn"><i class="fa fa-plus"></i> Industri</a>
...
<script>
        ...
        table = $("#datatable").DataTable({
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    <div class="btn-list">
                        ${state}
                        <a href="{{ route('industri.edit', ':id') }}" class="btn btn-primary" title="Profile Member">Profile</a>
    ...
    function edit(id){
        var url = "{{ route('industri.show',":id") }}";
        ...
        $.get(url, function (response) {
            ...
            $('#fb_url').attr('href', response.fb_url ?? 'javascript:void(0);');
            $('#ig_url').attr('href', response.ig_url ?? 'javascript:void(0);');
